...
public interface ISystemService
{
    ...
    Task<CaptainUserIgnoredPenalty?> GetCurrentUserIgnoredRequestsPenaltyByCaptainUserAccountIdAsync(string captainUserAccountId);
    //Task<CaptainUserRejectPenalty> GetCurrentUserRejectedRequestsPenaltyByCaptainUserAccountIdAsync(string captainUserAccountId);
    Task<IEnumerable<CaptainUserIgnoredPenalty>> GetUserIgnoredRequestsPenaltiesByCaptainUserAccountIdAsync(string captainUserAccountId);
    //Task<IEnumerable<CaptainUserRejectPenalty>> GetUserRejectedRequestsPenaltiesByCaptainUserAccountIdAsync(string captainUserAccountId);
